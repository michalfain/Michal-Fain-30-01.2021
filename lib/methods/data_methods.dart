...
class DataMethods {
  Future getData_real(String city) async {
  ...
  Future getTemperature_real(String newCity, String key) async {
  ...
  Future getFiveDaysForecast_real(String fiveDaysCity) async {
