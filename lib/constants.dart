...
class Constants {
  ...
  static const FAVORITE_CITY = 'city';
  static const FAVORITE_LIST_CITY = 'city list';
  ...
  static const API_KEY_5 = 'EBsmTX0NI4AWFJB6FyG4RmMBeXvkvgo8';
  static const API_KEY_6 = 'Sv6SkCbLVsqKSnvFlbll11387n6gBxVP';
  static const API_KEY_7 = 'RiENu4SLGjAJ2vIMo7acChG84F8AICms';
  ...
  // ignore: non_constant_identifier_names
  static List<String> CITY_LIST = [];
  // ignore: non_constant_identifier_names
  static List<String> KEY_LIST = [];
}
